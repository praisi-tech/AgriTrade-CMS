...
<html lang="en">
    <head>
        ...
        <title><?php echo $product['product_name']; ?> | AgriTrade CMS Catalog</title>
        ...
        <div class="container pb-5">
            <div class="row bg-white rounded-4 shadow-sm overflow-hidden d-flex align-items-stretch product-container">
                ...
                <div class="col-md-6 p-4 p-lg-5 d-flex flex-column justify-content-center">
                    ...
                    <h1 class="fw-bold display-6 mb-3"><?php echo $product['product_name']; ?></h1>
                    <p class="text-muted mb-4 lead" style="font-size: 1rem;"><?php echo $product['description']; ?></p>
                    ...
                    <div class="bg-light p-3 p-lg-4 rounded-3 mb-4 border-start border-4 border-success">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-borderless small mb-0">
                                <tr><td width="160" class="text-muted py-1">Technical Specs</td><td class="py-1">: <?php echo $product['specifications']; ?></td></tr>
                                <tr><td class="text-muted py-1">Key Advantages</td><td class="py-1">: <?php echo $product['advantages']; ?></td></tr>
                                <tr><td class="text-muted py-1">Capacity / Month</td><td class="py-1">: <?php echo $product['production_capacity']; ?></td></tr>
                                <tr><td class="text-muted py-1">Min. Order (MOQ)</td><td class="py-1">: <?php echo $product['moq']; ?></td></tr>
                                <tr><td class="text-muted py-1">Packaging</td><td class="py-1">: <?php echo $product['packaging']; ?></td></tr>
                                <tr><td class="text-muted py-1">Origin</td><td class="py-1">: Indonesia</td></tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="row g-2">
                        <div class="col-12 col-lg-6">
                            <a href="https://wa.me/6281200000000?text=Inquiry for <?php echo $product['product_name']; ?>" 
                            class="btn btn-success btn-lg w-100 fw-bold shadow-sm">WhatsApp Inquiry</a>
                        </div>
                        <div class="col-12 col-lg-6">
                            <a href="mailto:trade@agritrade-cms.com" class="btn btn-outline-dark btn-lg w-100 fw-bold">Email Inquiry</a>
                        </div>
                    </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="input-group mb-3 shadow-sm">
                            ...
                            <button class="btn btn-success btn-sm px-3" type="button">Subscribe</button>
                        </div>
                    </div>
